...
/**
 * Subarray Problems Collection
 *
 * <p><b>Problem Statement:</b><br>
 * Collection of subarray problems including minimum length with sum >= target, product less than k,
 * subarrays with k different integers, and sum equals k.
 *
 * <p><b>Intuition & Approach:</b><br>
 * Common subarray patterns:
 * - Sliding Window: Expand right, shrink left when condition met
 * - Prefix Sum + HashMap: Track cumulative sums for range queries
 * - Two Pointers: Maintain valid window dynamically
 * 
 * Problems use variations of these patterns to count, find minimum, or compute properties
 * of contiguous subarrays efficiently.
 *
 * <p><b>Time Complexity:</b> O(N) for most sliding window solutions
 * <br><b>Space Complexity:</b> O(K) to O(N) depending on problem
 */

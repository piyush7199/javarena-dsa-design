...
| 2 | MEDIUM | [Implement Trie Prefix Tree](https://leetcode.com/problems/implement-trie-prefix-tree) | [Solution](../datastructures/trie/Trie.java) | Hash Table, String, Design, Trie |
...
| 4 | EASY | [Available Captures For Rook](https://leetcode.com/problems/available-captures-for-rook) | [Solution](../datastructures/arrays/CapturesRook.java) | Array, Matrix, Simulation |

...
public class MobileAppSubscriber implements Subscriber {
    ...
    public MobileAppSubscriber(String deviceId, Set<String> symbols, Set<Category> categories, boolean isPremium) {
    ...
    public void update(StockPriceUpdate update) {
        System.out.println("Mobile App [" + deviceId + "] received push: " + update.getSymbol() +
